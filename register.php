...
<style>
        ...
        .hero-title { background: linear-gradient(90deg, #ff0099, #00c8ff); -webkit-background-clip: text; color: transparent; }
...
<a class="font-label-md text-label-md btn-neon px-8 py-3 rounded-full hover:scale-105 active:scale-95 transition-all duration-300 font-bold tracking-wide" href="login.php">Masuk</a>
</div>
</div>
</nav>

<main class="flex-grow pt-20 flex items-center min-h-screen">
<div class="relative z-10 w-full max-w-lg mx-auto px-margin-mobile md:px-margin-desktop py-16">
<div class="card-neon rounded-[20px] p-10">
<div class="text-center mb-8">
<h1 class="font-display-lg text-4xl font-black hero-title uppercase mb-2" style="background:linear-gradient(90deg,#ff0099,#00c8ff);-webkit-background-clip:text;color:transparent;">Daftar</h1>
<p class="font-body-md text-[#ddd]">Buat akun GameZone baru</p>
</div>
...
<div>
<label for="name" class="block mb-2 font-label-md">Nama Lengkap</label>
<input type="text" id="name" name="name" placeholder="Nama Anda" required class="w-full" value="<?= isset($_POST['name']) ? htmlspecialchars($_POST['name']) : '' ?>">
</div>
<div>
...
<div>
<label for="phone" class="block mb-2 font-label-md">Nomor Telepon <span class="text-white/30">(opsional)</span></label>
<input type="text" id="phone" name="phone" placeholder="089xxx" class="w-full" value="<?= isset($_POST['phone']) ? htmlspecialchars($_POST['phone']) : '' ?>">
</div>
<div>
<label for="password" class="block mb-2 font-label-md">Kata Sandi</label>
<input type="password" id="password" name="password" placeholder="Minimal 6 karakter" required class="w-full">
</div>
<div>
<label for="confirm_password" class="block mb-2 font-label-md">Konfirmasi Kata Sandi</label>
<input type="password" id="confirm_password" name="confirm_password" placeholder="Ulangi kata sandi" required class="w-full">
</div>
<div class="flex items-center gap-2">
<input type="checkbox" id="terms" required>
<label for="terms" class="text-sm text-[#ddd] cursor-pointer">Saya setuju dengan <a href="#" class="text-[#00c8ff] hover:text-[#ff0099] transition-colors">syarat & ketentuan</a></label>
</div>
...
<p class="font-body-md text-[#ddd]">
                    Sudah punya akun?
<a href="login.php" class="text-[#00c8ff] hover:text-[#ff0099] transition-colors font-semibold">Masuk di sini</a>
</p>
</div>
</div>
</div>
